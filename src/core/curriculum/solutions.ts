...
export const SOLUTIONS: Record<string, string[]> = {
  ...
  "s2-l4-e3": ["c", "i", "w", "d", "o", "g", "<Esc>"],
  "s2-l4-e4": ["w", "c", "i", "w", "v", "a", "l", "<Esc>"],
  "s2-l4-e5": ["w", "c", "i", "w", "y", "<Esc>"],
  "s2-l5-e1": ["f", '"', "d", "i", '"'],
  "s2-l5-e2": ["f", '"', "c", "i", '"', "y", "o", "<Esc>"],
  "s2-l5-e3": ["f", '"', "c", "i", '"', "b", "<Esc>"],
  "s2-l5-e4": ["f", '"', "d", "i", '"'],
  "s2-l5-e5": ["f", '"', "c", "i", '"', "n", "e", "w", "<Esc>"],
  "s2-l6-e1": ["f", "(", "d", "i", "("],
  "s2-l6-e2": ["f", "(", "c", "i", "(", "y", "<Esc>"],
  "s2-l6-e3": ["f", "(", "d", "i", "("],
  "s2-l6-e4": ["f", "(", "c", "i", "(", "x", "<Esc>"],
  "s2-l6-e5": ["f", "(", "c", "i", "(", "1", "<Esc>"],
  "s2-l7-e1": ["y", "y", "p"],
  "s2-l7-e2": ["y", "y", "p"],
  "s2-l7-e3": ["y", "y", "G", "p"],
  "s2-l7-e4": ["y", "y", "p", "p"],
  ...
  "s7-l4-e2": ["<C-v>", "j", "l", "d"],
  "s7-l4-e3": ["<C-v>", "G", "d"],
  "s7-l4-e4": ["<C-v>", "j", "l", "l", "d"],
  "s7-l5-e1": ["<C-v>", "j", "y", "p"],
  "s7-l5-e2": ["<C-v>", "G", "y", "p"],
  "s7-l5-e3": ["<C-v>", "j", "y", "$", "p"],
  "s7-l5-e4": ["<C-v>", "j", "l", "y", "$", "p"],
};
