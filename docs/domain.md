...
> 現時点でプロダクトコードは存在しないため、コード上の命名との食い違いは無い。この用語集が今後の命名の正典(カノン)となる。
...
| ステージ                    | `Stage`                                | カリキュラムの大区分。①基本移動・モード操作 ②編集オペレータ+テキストオブジェクト ③検索・置換・グローバルコマンド ④上級(レジスタ・複数ファイル/バッファ・ウィンドウ操作)。                                                                                                        |
...
| 学習活動                    | `LearningActivity`                     | ストリーク継続の条件となる活動。レッスンクリア・ドリルセッション完了・デイリーチャレンジクリアのいずれか。                                                                                                                                                                       |
...
| #   | 論点                      | 暫定判断                                                                                                                                                                                                                                                                                    | 根拠                                                                                                                                              |
| --- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1  | XP の具体量               | レッスンクリア 20 / ドリルお題クリア 金10・銀7・銅5 / デイリーチャレンジ初回クリア 15(金メダル時はボーナス+5)。実装: `core/progression/xp.ts`                                                                                                                                               | Duolingo 等の相場感。バランスは実装後に調整                                                                                                       |
...
| P5  | 弱点判定の閾値            | 直近5試行のうち銀以上が2回以下のコマンドを弱点とする                                                                                                                                                                                                                                        | 少ない試行数で判定できる単純なルールから始める                                                                                                    |
