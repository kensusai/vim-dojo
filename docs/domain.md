...
| ステージ                    | `Stage`                                | カリキュラムの大区分。①基本移動・モード操作 ②編集オペレータ+テキストオブジェクト ③検索・置換・グローバルコマンド ④効率化の型(A/I/o・r・J・ct/dt など実務頻出) ⑤検索の達人(* n・繰り返し) ⑥上級(レジスタ・複数ファイル/バッファ)。当初4→6に拡張(2026-07-12、コンテンツ量の要望による)。 |
